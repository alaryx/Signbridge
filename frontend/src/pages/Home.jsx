    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gray-50 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                <div className="absolute -top-40 -right-40 w-96 h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
                <div className="absolute top-40 -left-40 w-96 h-96 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
            ...
            <div className="max-w-3xl text-center flex flex-col items-center space-y-8 z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                    <a href="/translation" className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-teal-600 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-600 hover:bg-teal-700 hover:scale-105 active:scale-95 shadow-lg shadow-teal-500/30">
                        Start Translating
                    ...
                    <a href="/learn" className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-teal-700 transition-all duration-200 bg-teal-50 border border-teal-200 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-600 hover:bg-teal-100 hover:border-teal-300 hover:scale-105 active:scale-95 shadow-sm">
                        Learn ISL
                    </a>
                </div>
            </div>
