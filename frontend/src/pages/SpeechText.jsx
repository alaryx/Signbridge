        ...
        <div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
            <div className="w-full bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="bg-brand-600 p-6 text-center">
                    ...
                    <p className="text-brand-100 mt-1">Supplementary communication tools</p>
                </div>
                ...
                <div className="p-8 space-y-8 flex flex-col items-center">
                    ...
                    ${isListening
                                ...
                                : 'bg-brand-500 hover:bg-brand-600 hover:scale-105 shadow-brand-500/30'
                            }`}
                        >
                    ...
                    <div className="w-full relative">
                        <textarea
                            ...
                            className="w-full h-40 p-4 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-shadow text-gray-700 bg-gray-50"
                        ></textarea>

                        <button className="absolute bottom-4 right-4 bg-white p-2 text-brand-600 rounded-full shadow-sm border border-gray-100 hover:bg-brand-50 hover:scale-105 active:scale-95 transition-all">
