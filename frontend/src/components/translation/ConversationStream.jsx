                ...
                ${isISL
                            ...
                            >
                                ...
                                {isISL && msg.confidence && (
                                    <div className="absolute -top-3 left-2 flex items-center gap-1 bg-white border border-gray-100 shadow-sm px-2 py-0.5 rounded-full text-[10px] font-bold text-teal-600">
                  ...
                  ${isISL ? 'text-gray-400' : 'text-teal-200'}`}
                                >
                                    <span>
                                    ...
                                    {isISL && (
                                        <button className="hover:text-teal-600 transition-colors bg-gray-50 hover:bg-teal-50 rounded-full p-1 ml-auto">
                                            <Volume2 size={14} />
                                        </button>
                                    )}
                                    {!isISL && (
                                        <button className="hover:text-white transition-colors bg-teal-700 hover:bg-teal-500 rounded-full p-1 ml-auto">
